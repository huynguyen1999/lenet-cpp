#ifndef SRC_LAYER_CONV_CM_GPU_H_
#define SRC_LAYER_CONV_CM_GPU_H_
...
public:
    ConvCmGpu(int channel_in, int height_in, int width_in, int channel_out,
